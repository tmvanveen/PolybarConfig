...
# Uncomment headless once confirmed working
...
try:
    ...
    if temp_span:
        ...
        print(f"{temp}")  # Outputs "11°" (Polybar will handle it fine)
    else:
        print("Temperature not found. Check page source:")
        print(driver.page_source[:2000])  # Debug output
